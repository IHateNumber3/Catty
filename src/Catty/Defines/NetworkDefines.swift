...
class NetworkDefines: NSObject {
    ...
    // Confirmed by live testing: the path structure itself is unchanged, still under
    // "/app/" (e.g. share.catrobat.org/app/ works and all further navigation stays
    // under /app/) — only the domain changed.
    static let shareUrlProduction = "https://share.catrobat.org/"
    static let shareUrlTesting = "https://share.catrobat.org/"
