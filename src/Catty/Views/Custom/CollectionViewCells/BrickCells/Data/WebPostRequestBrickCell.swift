...
class WebPostRequestBrickCell: BrickCell, BrickCellProtocol {
    ...
    override func hookUpSubViews(_ inlineViewSubViews: [Any]!) {
        ...
        self.bodyTextLabel = inlineViewSubViews[2] as? UILabel
        self.bodyTextField = inlineViewSubViews[3] as? UITextField
        self.bottomTextLabel = inlineViewSubViews[4] as? UILabel
        self.variableComboBox = inlineViewSubViews[5] as? iOSCombobox
    }
